...
SmartApp =  (function (SmartApp, $, window) {
	...
	// ChartsJS @v1.0
    SmartApp.Chart.ChartJs = function () {
        
        SmartApp.Chart.ChartJs.Doughnut = function (_canvas, _titles, _colors, _amounts, _canvas_border, _canvas_cutout) {
            if ($('#'+_canvas).length) {
        ...
        SmartApp.Chart.ChartJs.Doughnut2 = function (_canvas, _titles, _colors, _amounts, _canvas_border, _canvas_cutout) {
            if ($('#'+_canvas).length) {
                var _canvas_el = document.getElementById(_canvas).getContext("2d");
                var doughnut_chart = new Chart(_canvas_el, {
                    type: 'doughnut',
        ...
        // @since v1.6
        SmartApp.Chart.ChartJs.Pie = function (_canvas, _label, _title, _colors, _colors_hover, _amounts, _canvas_border, _canvas_cutout) {
            if ($('#'+_canvas).length) {
                var _canvas_el = document.getElementById(_canvas).getContext("2d");
            ...
            $chart.each(function(){
                ...
                if(typeof _canvas!=='undefined' && _canvas !=='') {
                    ...
                    if (_canvas_type==='doughnut') {
                        SmartApp.Chart.ChartJs.Doughnut(_canvas, item_label, item_color, item_percent,_canvas_border,_canvas_cutout);
                    } else if(_canvas_type==='pie') {
                        SmartApp.Chart.ChartJs.Pie(_canvas, item_label, item_color, item_percent,_canvas_border);
                    } else if(_canvas_type==='linechart') {
                        SmartApp.Chart.ChartJs.Doughnut(_canvas, item_label, item_color, item_percent,_canvas_border);
                    }
                } else {
        ...
        if($chart_s2.length > 0){
            $chart_s2.each(function(){
                ...
                if(typeof _canvas!=='undefined' && _canvas !=='') {
                    ...
                    if (_canvas_type==='doughnut') {
                        SmartApp.Chart.ChartJs.Doughnut(_canvas, item_label, item_title, item_color, item_percent, _canvas_border,_canvas_cutout);
                    } else if(_canvas_type==='pie') {
                        SmartApp.Chart.ChartJs.Pie(_canvas, item_label, item_title, item_color, item_color_hover, item_percent, _canvas_border);
                    } else if(_canvas_type==='linechart') {
                        SmartApp.Chart.ChartJs.Doughnut(_canvas, item_label, item_title, item_color, item_percent, _canvas_border);
                    }
                } else {
                    console.log('Unable to draw canvas: '+_canvas);
                }
        ...
        if($chart_s1.length > 0){
            $chart_s1.each(function(){
                ...
                if(typeof _canvas!=='undefined' && _canvas !=='') {
                    ...
                    if (_canvas_type==='doughnut') {
                        SmartApp.Chart.ChartJs.Doughnut2(_canvas, item_label, item_color, item_percent, _canvas_border,_canvas_cutout);
                    } else if(_canvas_type==='pie') {
                        SmartApp.Chart.ChartJs.Pie(_canvas, item_label, item_color, item_color_hover, item_percent, _canvas_border);
                    } else if(_canvas_type==='linechart') {
                        SmartApp.Chart.ChartJs.Doughnut(_canvas, item_label, item_color, item_percent, _canvas_border);
                    }
                } else {
    ...
    SmartApp.components.docReady.push(SmartApp.Chart.ChartJs);
	return SmartApp;
