    ...
    'pageTemplates': function (context) {
      ...
      this.initialize = function () {
        ...
        this.$dialog   = ui.dialog({
          ...
          body:   body,
          footer: '<button type="button" href="#" class="note-btn note-btn-primary note-pageTemplates-btn btn btn-primary btn-sm">' + lang.pageTemplates.editBtn + '</button>'
    ...
    'blocks': function (context) {
      ...
      this.initialize = function () {
        ...
        this.$dialog = ui.dialog({
          ...
          body:   body,
          footer: '<button type="button" href="#" class="note-btn note-btn-primary note-blocks-btn btn btn-primary btn-sm">' + lang.blocks.editBtn + '</button>'
        }).render().appendTo($container);
      };
      this.destroy = function () {
        ui.hideDialog(this.$dialog);
        ...
        return $.Deferred(function (deferred) {
          ...
          ui.onDialogShown(self.$dialog, function () {
                ...
                if (val.match(/\.(html)$/)) {
                  ...
                  pT = '<div class="note-blocks">' +
                    ...
                    '<label for="note-select-' + ii + '" class="note-blocks-label">' +
                      '<img src="' + options.blocks.templates.replace('index.html','') + filename + '" class="note-thumb-selection">' +
                    '</label>' +
                  '</div>';
            ...
            $blocksBtn.click(function (e) {
              ...
              if (blocksSelected) {
                $.get(options.blocks.templates.replace('index.html','') + blocksSelected).done(function (data) {
                  data = data + '<br />';
