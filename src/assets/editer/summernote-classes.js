  ...
  $.extend(true, $.summernote.lang, {
    'en-US': {
      classes: {
        ...
        h1:['title-s1','title-s2','title-s3','title-s4','title-s5','title-s6','title-s7'],
        h2:['title-s1','title-s2','title-s3','title-s4','title-s5','title-s6','title-s7'],
        h3:['title-s1','title-s2','title-s3','title-s4','title-s5','title-s6','title-s7']
      }
    }
  });
